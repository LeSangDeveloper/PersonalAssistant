...
public class WorksDataSource {
    ...
    private String[] allColumns = {WorksSQLiteHelper.COLUMN_ID, WorksSQLiteHelper.COLUMN_TITLE, WorksSQLiteHelper.COLUMN_DATE, WorksSQLiteHelper.COLUMN_TIME, WorksSQLiteHelper.COLUMN_LOCATION};
    ...
    public Work createWork(String title, String date, String time, String location)
    {
    ...
    {
        long id = w.getId();
        Log.e("SQLite", "Person entry delete with " + id);
